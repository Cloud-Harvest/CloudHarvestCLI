...
# Matching -m
matching_parser = ArgumentParser(formatter_class=RawTextRichHelpFormatter, add_help=False)
...
# Formatting --format
format_parser = ArgumentParser(formatter_class=RawTextRichHelpFormatter, add_help=False)
...
key_manipulation_parser = ArgumentParser(formatter_class=RawTextRichHelpFormatter, add_help=False)
...
refresh_parser = ArgumentParser(formatter_class=RawTextRichHelpFormatter, add_help=False)
